...
void input_array(int n, int m, double** array) {
    for (int i = 0; i < n; i++) {
        cout << "¬ведите элемент " << i + 1 << " строки: \n";
        for (int j = 0; j < m; j++) {
            cin >> array[i][j];
        }
    }
...
void summa() {
    int n, m;
    do {
        cout << "¬ведите количество строк в матрицах\n";
        cin >> n;
    } while (n <= 0);
    do {
        cout << "¬ведите количество столбцов в матрицах\n";
        cin >> m;
    } while (m <= 0);
...
void umnojenie() {
    ...
    do {
        cout << "¬ведите количество столбцов первой матрицы: \n";
        cin >> m1;
    } while (m1 <= 0);
    do {
    ...
    do {
        cout << "¬ведите количество столбцов второй матрицы: \n";
        cin >> m2;
    } while (m2 <= 0);

    if (m1 != n2) { cout << "”множение невозможно!\n"; }
    else {
        double** array1;
        double** array2;
...
void determinant() {
    ...
    if (n != m) { cout << "Ќевозможно найти определитель"; }
    if (n == m) {
        double** array;
        array = create_array(n, m);
        input_array(n, m, array);
...
void matrix_menu()
{
    int way;
    while (true) {
        cout << "что вы хотите посчитать?\n";
        cout << "0 - выход из калькул€тора матриц";
        cout << "1 - сумму матриц\n";
